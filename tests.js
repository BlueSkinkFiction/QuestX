...
test.tests = function() {
  ...
  test.title("Bondage");
  test.assertCmd("tie j up", ["You manacle Joanna's wrists to the top of the A-frame, then make her open her legs wide, before manacling them too."]);
  ...
  console.log(createWoman("lounge"));
};
